...
// @ts-ignore
import backgroundImg from "../../assets/giphy 3.png";
...
const AppSecure = () => {
  ...
  const title = "Services-appSecure | AUVNET";
  const description = "Services-appSecure | AUVNET";
  ...
  return (
    <>
      <HtmlHead title={title} description={description}>
        <meta property="og:site_name" content="AUVNET App Secure" />
        <meta
          property="og:title"
      ...
      "
        ...
        <meta
          property="og:url"
          content="https://AUVNET.com/services/appsecure"
        />
      ...
      <div className="uiux">
        <div className="main-container">
          ...
          >
            ...
            <div className="parent_ttopp_fformm">
              <h3>
                {" "}
                {i18n.language === "en" && "Request a App Secure service"}
                {i18n.language === "ar" && "اطلب خدمة تأمين التطبيقات"}
              </h3>
              <div className="pparen_bbuttonsss">
                <button className="ccontactt_uttonn">
                ...
                <button
                  className="ssendd_uttonn send-black-color"
